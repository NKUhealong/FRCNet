...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.adaptmlp = Adapter(d_model=dim,dropout=0.1,adapter_scalar=0.10)
    ...
    def forward(self, x, H, W):
        ...
        x = x + self.drop_path(self.mlp(self.norm2(x), H, W)) +adapt
        return x
...
class MixVisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        #####
        self.DTC_conv1_1 = nn.Conv2d(64, 192, kernel_size=1, stride=1, bias=False, padding =0)
    ...
    def forward_features(self, x):
        ...
        num_batchsize,size = feat_DCT.shape[0], x.shape[2]
        feat_DCT = DCT.dct_2d(feat_DCT, norm='ortho')
        feat_DCT = feat_DCT.half()
        
        #feat_DCT = F.relu(feat_DCT)
        #print(feat_DCT.max(),feat_DCT.min())
...
# model = Adapter_SegFormer_B4(512,2)
